...
{
    public class Sys_EnemyController : JobComponentSystem
    {
        ...
        protected override JobHandle OnUpdate(JobHandle inputDeps)
        {
            ...
            JobHandle jobHandle = Entities.WithAll<Tag_Enemy>().ForEach(
            (
                ...
                if (translation.Value.y <= -5f)
                {
                    ...
                    // concurrent.DestroyEntity(entityInQueryIndex, ent);
                }
